...
mongoose.connect("mongodb+srv://" + process.env.DB_UID + process.env.DB_PWD + "@cluster0-qrkv6.mongodb.net/todolistDB?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false });
